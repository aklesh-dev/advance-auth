      ...
      >
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          <div className="flex justify-between">
            {code.map((digit, index) => (
              <input
                ...
                className="w-12 h-12 text-center text-2xl font-bold bg-gray-700 text-white border-2 border-gray-500 rounded-lg focus:outline-none focus:border-green-500"
              />
            ))}
          </div>
          ...
          <motion.button
            ...
            disabled={isLoading}
          >
            {isLoading ? <Loader className="animate-spin mx-auto w-5 h-5" /> : "Verify Email"}
          </motion.button>
        </form>
      </motion.div>
    </section>
